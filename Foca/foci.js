...
function searchPlayer() {
    ...
    for (let talalat of talalatok) {
        document.getElementById("talalatok").innerHTML += `<li>${talalat.jatekos_neve} (${talalat.csapat_neve})</li>`
    }
...
function topPlayer(){
    ...
    for (let csapat of csapatok) {
        ...
        for (let talalat of tmpGollovok) {
            ...
            document.getElementById("topJatekosok").innerHTML += `<li>${talalat.jatekos_neve} (${talalat.csapat_neve}) rúgott gólok: ${talalat.rugott_gol}</li>`
        }
